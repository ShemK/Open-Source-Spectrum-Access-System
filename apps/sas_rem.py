...
# Title: Sas Rem
# Generated: Thu Jun 22 17:57:31 2017
##################################################
...
class sas_rem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.utils_nmea_reader_0 = utils.nmea_reader('localhost', 2222, 'nmea')
        ...
        self.msg_connect((self.sas_sas_buffer_0, 'number_of_samps'), (self.blocks_message_debug_0, 'print'))
